...
/*kartica za menu sa slikom


<div class="proba">
	<div>
		<img src="../RESIZE.PNG" alt="pROBA">
	</div>
	<div>
		<h2>Belo pileće meso</h2>
		<hr style="width:100%">
		<p>sir,omaka,crveno meso,bela corba</p>
	</div>
	<div>
		<span>400px</span>
	</div>
...
<div class="proba">
	...
	<div>
		<h2>Belo pileće meso 239gr.</h2>
		<hr style="width:100%">
		<p>sir,omaka,crveno meso,bela corba<br>,sir,pita ,dfdf</p>
	</div>
	<div>
		<span>1400px</span>
	</div>
...
.proba div h2{
	filter:drop-shadow(0 0 10px slateblue);
	font-size:130%;
}
.proba div p{
	line-height:normal;
